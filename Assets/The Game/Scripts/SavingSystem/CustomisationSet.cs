...
public class CustominsationSet : MonoBehaviour
{
   ...
   [Header("Current Texture Index")] // Indexes helps us restrict how many textures we have inside here....
   public int skinIndex;
   public int eyesIndex, mouthIndex, hairIndex, armourIndex, clothesIndex;
   [Header ("Max amount of textures per type")] // Similar to indexing actually its the same...
   public int skinMax;
   public int eyesMax, mouthMax, hairMax, armourMax, clothesMax;
   [Header("Renderer")]
   public Renderer characterRenderer;
   
   private string[] matName = new string[6]; // Material name!
   ...
   private void Start()
   {
      matName = new string[] { "Skin", "Eyes", "Mouth", "Hair", "Armour", "Clothes" }; // To show in game

      selectedClass = new string[] { "Barbarian", "Ranger", "Mage" }; // To show in game
      ...
      // Adds all the textures from Resources into their respective lists nothing crazy here though a bit too much fors... man gifs...
   ...
   public void NameInput()
   {
    ...
    public void RaceDropdown(int index)
    {
        switch (index)
        {
            ...
            case 1:
                raceIndex = 1;
                raceName = "Human";
                raceAbilityText.text = "The Humans special ability is Call to Arms. Enemies will focus on player for 20s.";
                break;
            case 2:
                raceIndex = 2;
                raceName = "Elf";
            ...
            case 3:
                raceIndex = 3;
                raceName = "Dwarf";
                raceAbilityText.text = "The Dwarfs special ability is Call of the Deep. Blind all enemys for 20s. Who knew being short was scary...!";
    ...
    //Sets the stats and stats for each class... good old switch ah...
...
// This whole script is agonizing! I mean its all from the gif so how else can we adapt it now...